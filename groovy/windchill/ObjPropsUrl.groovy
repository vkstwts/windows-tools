...
println "BaseURL  :"+factory.getBaseURL();
println "BaseHREF :"+factory.getBaseHREF();
println "BaseHREFFromRequestURI :"+factory.getBaseHREFFromRequestURI();
println "RequestURI :"+factory.getRequestURI();